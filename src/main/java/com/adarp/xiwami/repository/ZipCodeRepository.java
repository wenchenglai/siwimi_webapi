...
public interface ZipCodeRepository extends MongoRepository<ZipCode, String>, ZipCodeRepositoryCustom{
	...
	//public ZipCode findByTownshipLikeIgnoreCaseAndStateCodeLikeIgnoreCase(String city, String stateCode);
	public ZipCode findByTownshipLikeIgnoreCaseAndStateLikeIgnoreCase(String city, String state);
