...
public class EmailNotificationController {
	...
	@RequestMapping(value = "/member/{creatorId}/email-notification", method = RequestMethod.GET, produces = "application/json")
	...
	@RequestMapping(value = "/member/{creatorId}/email-notification", method = RequestMethod.PUT, produces = "application/json")
